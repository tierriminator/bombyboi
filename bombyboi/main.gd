...
const ENERGY_SPAWN_P = 0.3
const PINK_ENERGY_P = 0.3
const SPAWN_BOTTLE_P = 0.2

const AI_WAIT_AVG = 0.5
const AI_WAIT_RANGE = 0.2

const BOMBE_IN_FLESCHE_MOVE_FREQ = 0.2
